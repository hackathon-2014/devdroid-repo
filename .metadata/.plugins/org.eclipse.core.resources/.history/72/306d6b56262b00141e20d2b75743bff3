 ...
 *
 */
public class ScheduleNotification extends ActionBarActivity {
    ...
    public void onDateSelectedButtonClick(View v){
    	...
    	Log.d("dsfasd", String.valueOf(sec));
    	Toast.makeText(ScheduleNotification.this, String.valueOf(hour) + "/" + String.valueOf(hour) +  "/" + String.valueOf(hour), Toast.LENGTH_SHORT).show();
